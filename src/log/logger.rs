...
mod tests {
    ...
    async fn test_logger_with_struct_metadata() -> Result<()> {
        use serde::Serialize;
        use crate::log::record::MetadataValue;
